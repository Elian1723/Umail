...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <main>
        <div class="w-100 d-flex justify-content-between align-items-center">
            <h1 class="d-block ms-3 ms-sm-0 mb-3 text-white">Eliminados</h1>
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-CssClass="" HeaderStyle-CssClass="w-25">
                        <ItemTemplate>
                            <div class="d-flex">
                                <div>
                                    <asp:LinkButton runat="server" CssClass="bg-transparent" CommandName="Sacar" CommandArgument="<%# Container.DataItemIndex.ToString()%>">
                            <i class="fa-solid fa-trash-can-arrow-up rounded-5 p-2 me-1 hover-icon" data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip" data-bs-title="Sacar de la papelera" data-bs-placement="top" data-bs-delay='{"show": 400, "hide": 0}'></i>
                                    </asp:LinkButton>
                                </div>
                                <div class="d-flex">
                                    <asp:LinkButton runat="server" CssClass="bg-transparent" CommandName="Eliminar" CommandArgument="<%# Container.DataItemIndex.ToString()%>">
            ...
            <div class="modal-content bg-dark">
                <div class="modal-header d-flex flex-column">
                    <div class="w-100 d-flex flex-column justify-content-center">
                        ...
                        <div>
                            <asp:Label ID="LabelGrupo" runat="server" />
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer border-0 d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        <asp:Button Text="Eliminar definitivamente" type="button" CssClass="btn btn-danger" runat="server" ID="ButtonEliminar" OnClick="ButtonEliminar_Click" />
                    </div>
                </div>
            </div>
        </div>
